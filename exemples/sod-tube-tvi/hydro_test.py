...
cfg.set_dust_config_tvi(rho_grain = 2700, dust_sizes = [1e-3])
...
#set dustfrac 0.5
# sdust = sqrt(epsilon rho)
epsilon_gd = 0.5
Sdust_g = (rho_g * epsilon_gd) ** 0.5
Sdust_d = (rho_d * epsilon_gd) ** 0.5
model.set_value_in_a_box("Sdust", "f64", Sdust_g ,(-xs,-ys/2,-zs/2),(0,ys/2,zs/2))
model.set_value_in_a_box("Sdust", "f64", Sdust_d ,(0,-ys/2,-zs/2),(xs,ys/2,zs/2))
...
plt.plot(x,Sdust**2 / rho,'.',label="epsilon")
#plt.plot(x,dSdust,'.',label="dSdust")
