...
model.set_value_in_a_box("epsilon", "f64", epsilon ,(-xs/2,-ys/2,-zs/2),(xs/2,ys/2,zs/2))
...
def analyse():
    ...
    for i in range(len(x)):
        ...
        _dtdeltavx = - _dtepsilon*_vx_g + (1-_epsilon)*_ax_g + _dtepsilon*_vx_d + _epsilon*_ax_d
