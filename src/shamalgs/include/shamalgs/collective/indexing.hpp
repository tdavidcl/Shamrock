...
namespace shamalgs::collective {
    ...
    inline ViewInfo fetch_view(u64 byte_count) {
        ...
        u64 scan_val;
        shamcomm::mpi::Exscan(&byte_count, &scan_val, 1, get_mpi_type<u64>(), MPI_SUM, MPI_COMM_WORLD);
        ...
        u64 sum_val;
        shamcomm::mpi::Allreduce(&byte_count, &sum_val, 1, get_mpi_type<u64>(), MPI_SUM, MPI_COMM_WORLD);
