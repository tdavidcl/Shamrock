...
TestStart(Unittest, "shamalgs/primitives/dot_sum/scalar_types", test_dot_sum_scalar_types, 1) {
...

    {
        ...
        i32 result = shamalgs::primitives::dot_sum(sched, buf, 0, static_cast<u32>(data.size()));
...

    {
        ...
        u32 start  = 2;
        u32 end    = 5;
        i32 result = shamalgs::primitives::dot_sum(sched, buf, start, end);
...

    {
        ...
        i32 result = shamalgs::primitives::dot_sum(sched, buf, 0, 1);
...

    {
        ...
        f32 result = shamalgs::primitives::dot_sum(sched, buf, 0, static_cast<u32>(data.size()));
...

    {
        ...
        f64 result = shamalgs::primitives::dot_sum(sched, buf, 0, static_cast<u32>(data.size()));
...

    {
        ...
        u32 result = shamalgs::primitives::dot_sum(sched, buf, 0, static_cast<u32>(data.size()));
...
TestStart(Unittest, "shamalgs/primitives/dot_sum/vector_types", test_dot_sum_vector_types, 1) {
...

    {
        ...
        u32 start  = 1;
        u32 end    = 4;
        f64 result = shamalgs::primitives::dot_sum(sched, buf, start, end);
...
TestStart(Unittest, "shamalgs/primitives/dot_sum/edge_cases", test_dot_sum_edge_cases, 1) {
...

    {
        ...
        i32 result = shamalgs::primitives::dot_sum(sched, buf, 2, 2);
...

    {
        ...
        REQUIRE_EXCEPTION_THROW(
            shamalgs::primitives::dot_sum(sched, buf, 4, 2), std::invalid_argument);
    }
...

    {
        ...
        for (u32 array_size : {1U, 2U, 4U, 8U, 16U, 32U, 64U, 128U, 256U, 512U, 1024U}) {
            ...
            f64 result = shamalgs::primitives::dot_sum(sched, buf, 0, array_size);
...

    {
        ...
        f64 result = shamalgs::primitives::dot_sum(sched, buf, 0, size);
