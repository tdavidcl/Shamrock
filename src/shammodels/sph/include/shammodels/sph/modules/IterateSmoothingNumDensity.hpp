...
/**
 * @file IterateSmoothingNumDensity.hpp
...
namespace shammodels::sph::modules {
    ...
    class IterateSmoothingNumDensity : public shamrock::solvergraph::INode {
        ...
        public:
        IterateSmoothingNumDensity(Tscal gpart_mass, Tscal h_evol_max, Tscal h_evol_iter_max)
        ...
        inline virtual std::string _impl_get_label() { return "IterateSmoothingNumDensity"; };
