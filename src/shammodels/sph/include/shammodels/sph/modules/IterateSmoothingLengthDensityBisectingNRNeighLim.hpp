...
/**
 * @file IterateSmoothingLengthDensityBisectingNRNeighLim.hpp
 * @author Timothée David--Cléris (tim.shamrock@proton.me)
 * @brief Declares the IterateSmoothingLengthDensityBisectingNRNeighLim module for iterating
...
namespace shammodels::sph::modules {
    ...
    class IterateSmoothingLengthDensityBisectingNRNeighLim : public shamrock::solvergraph::INode {
        ...
        public:
        IterateSmoothingLengthDensityBisectingNRNeighLim(
            Tscal gpart_mass,
            Tscal h_evol_max,
            Tscal h_evol_iter_max,
            u32 trigger_threshold,
        ...
        inline void set_edges(
            ...
            __internal_set_rw_edges({new_h, eps_h, h_bisect_lo, h_bisect_hi, was_limited});
        }
        ...
        inline Edges get_edges() {
            return Edges{
                ...
                get_rw_edge<shamrock::solvergraph::IFieldSpan<u32>>(4)};
        }

        void _impl_evaluate_internal();

        inline virtual std::string _impl_get_label() const {
            return "IterateSmoothingLengthDensityBisectingNRNeighLim";
        };
