...
/**
 * @file IterateSmoothingLengthNumDensity.hpp
...
namespace shammodels::sph::modules {
    ...
    class IterateSmoothingLengthNumDensity : public shamrock::solvergraph::INode {
        ...
        public:
        IterateSmoothingLengthNumDensity(Tscal gpart_mass, Tscal h_evol_max, Tscal h_evol_iter_max)
        ...
        inline virtual std::string _impl_get_label() { return "IterateSmoothingLengthNumDensity"; };
