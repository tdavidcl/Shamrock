...
/**
 * @file IterateSmoothingLengthNumDensity.cpp
...
void IterateSmoothingLengthNumDensity<Tvec, SPHKernel_old>::_impl_evaluate_internal() {
    ...
    using SPHKernel = shammath::M4DH7<Tscal>;
    // using SPHKernel = shammath::M4Shift16<Tscal>;
...
std::string IterateSmoothingLengthNumDensity<Tvec, SPHKernel>::_impl_get_tex() {
...
template class shammodels::sph::modules::IterateSmoothingLengthNumDensity<f64_3, shammath::M4<f64>>;
template class shammodels::sph::modules::IterateSmoothingLengthNumDensity<f64_3, shammath::M6<f64>>;
template class shammodels::sph::modules::IterateSmoothingLengthNumDensity<f64_3, shammath::M8<f64>>;

template class shammodels::sph::modules::IterateSmoothingLengthNumDensity<f64_3, shammath::C2<f64>>;
template class shammodels::sph::modules::IterateSmoothingLengthNumDensity<f64_3, shammath::C4<f64>>;
template class shammodels::sph::modules::IterateSmoothingLengthNumDensity<f64_3, shammath::C6<f64>>;
