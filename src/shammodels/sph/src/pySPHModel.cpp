...
void add_instance(py::module &m, std::string name_config, std::string name_model) {
    ...
    py::class_<TConfig>(m, name_config.c_str())
        ...
        .def(
            "set_self_gravity_mm",
            [](TConfig &self, u32 mm_order, f64 opening_angle) {
                self.self_grav_config.set_mm(mm_order, opening_angle);
            },
            py::kw_only(),
            py::arg("order"),
        ...
        .def(
            ...
            [](TConfig &self, u32 fmm_order, f64 opening_angle) {
                self.self_grav_config.set_fmm(fmm_order, opening_angle);
            },
            py::kw_only(),
            py::arg("order"),
            py::arg("opening_angle"))
