...
void shammodels::basegodunov::Solver<Tvec, TgridVec>::init_solver_graph() {
    ...
    { // flux
        ...
        if (solver_config.riemman_config == Rusanov) {
            modules::NodeComputeFluxGasDirMode<
                Tvec,
                TgridVec,
                modules::RiemannSolverMode::Rusanov,
                modules::Direction::xm>
                node_xm(solver_config.eos_gamma);
            node_xm.set_edges(
                storage.cell_graph_edge,
                storage.rho_face_xm,
                storage.vel_face_xm,
            ...
            modules::NodeComputeFluxGasDirMode<
                ...
                TgridVec,
                modules::RiemannSolverMode::Rusanov,
                modules::Direction::xp>
                node_xp(solver_config.eos_gamma);
            node_xp.set_edges(
                storage.cell_graph_edge,
                storage.rho_face_xp,
                storage.vel_face_xp,
            ...
            modules::NodeComputeFluxGasDirMode<
                ...
                TgridVec,
                modules::RiemannSolverMode::Rusanov,
                modules::Direction::ym>
                node_ym(solver_config.eos_gamma);
            node_ym.set_edges(
                storage.cell_graph_edge,
                storage.rho_face_ym,
                storage.vel_face_ym,
            ...
            modules::NodeComputeFluxGasDirMode<
                ...
                TgridVec,
                modules::RiemannSolverMode::Rusanov,
                modules::Direction::yp>
                node_yp(solver_config.eos_gamma);
            node_yp.set_edges(
                storage.cell_graph_edge,
                storage.rho_face_yp,
                storage.vel_face_yp,
            ...
            modules::NodeComputeFluxGasDirMode<
                ...
                TgridVec,
                modules::RiemannSolverMode::Rusanov,
                modules::Direction::zm>
                node_zm(solver_config.eos_gamma);
            node_zm.set_edges(
                storage.cell_graph_edge,
                storage.rho_face_zm,
                storage.vel_face_zm,
            ...
            modules::NodeComputeFluxGasDirMode<
                ...
                TgridVec,
                modules::RiemannSolverMode::Rusanov,
                modules::Direction::zp>
                node_zp(solver_config.eos_gamma);
            node_zp.set_edges(
                storage.cell_graph_edge,
                storage.rho_face_zp,
                storage.vel_face_zp,
            ...
            modules::NodeComputeFluxGasDirMode<
                Tvec,
                TgridVec,
                modules::RiemannSolverMode::HLLC,
                modules::Direction::xm>
                node_xm(solver_config.eos_gamma);
            node_xm.set_edges(
                storage.cell_graph_edge,
        ...
        if (solver_config.is_dust_on()) {
            ...
            if (solver_config.dust_config.dust_riemann_config == DHLL) {
                modules::NodeComputeFluxDustDirMode<
                    Tvec,
                    TgridVec,
                    modules::DustRiemannSolverMode::DHLL,
                    modules::Direction::xm>
                    node_xm(ndust);
                node_xm.set_edges(
                    storage.cell_graph_edge,
                ...
                modules::NodeComputeFluxDustDirMode<
                    Tvec,
                    TgridVec,
                    modules::DustRiemannSolverMode::HB,
                    modules::Direction::xm>
                    node_xm(ndust);
                node_xm.set_edges(
                    storage.cell_graph_edge,
