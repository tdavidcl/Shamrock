...
/**
 * @file NodeDragIntegratorEXPO.hpp
 * @author Anass Serhani (anass.serhani@cnrs.fr)
 * @author Léodasce Sewanou (leodasce.sewanou@ens-lyon.fr)
 * @author Timothée David--Cléris (tim.shamrock@proton.me)
 * @brief Exponential (matrix exponential) drag integrator
 *
 */
...
namespace shammodels::basegodunov::modules {
     ...
     */
    template<class Tvec>
    class NodeDragIntegratorEXPO : public shamrock::solvergraph::INode {
        ...
        public:
        NodeDragIntegratorEXPO(u32 block_size, u32 ndust, bool enable_frictional_heating)
        ...
        inline virtual std::string _impl_get_label() const { return "DragIntegratorEXPO"; };
