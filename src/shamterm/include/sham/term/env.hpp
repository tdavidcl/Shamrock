 ...
 * @brief Environment variable parsing for terminal color, size, UTF-8 and truecolor support
 * configuration (TERM, COLORTERM, NO_COLOR, CLICOLOR_FORCE, COLUMN, LANG, LC_ALL, LC_CTYPE,
 * NO_UTF8, FORCE_UTF8, NO_TRUECOLOR, FORCE_TRUECOLOR)
 *
 */
...
namespace sham::term {
    ...
    /// CLICOLOR_FORCE, COLUMN, LANG, LC_ALL, LC_CTYPE, NO_UTF8, FORCE_UTF8, NO_TRUECOLOR,
    /// FORCE_TRUECOLOR)
    ///
    ...
    struct TermEnvVars {
        ...
        std::optional<std::string_view> NO_TRUECOLOR;
        std::optional<std::string_view> FORCE_TRUECOLOR;
    };
