...
namespace shamphys {
    ...
    inline shammath::SymTensorCollection<T, low_order, high_order> offset_multipole_delta(
        ...
        if constexpr (low_order == 0 && high_order == 5) {
            ...
            //     2*Q.t2.v_02*d.t1.v_2 + 2*Q.t1.v_2*d.t2.v_02 + Q.t1.v_0*d.t2.v_22 +
            //     Q.t0*d.t3.v_022, Q.t3.v_111 + 3*Q.t2.v_11*d.t1.v_1 + 3*Q.t1.v_1*d.t2.v_11 +
            //     Q.t0*d.t3.v_111, Q.t3.v_112 + 2*Q.t2.v_12*d.t1.v_1 + Q.t2.v_11*d.t1.v_2 +
            //     Q.t1.v_2*d.t2.v_11 + 2*Q.t1.v_1*d.t2.v_12 + Q.t0*d.t3.v_112, Q.t3.v_122 +
            //     Q.t2.v_22*d.t1.v_1 + 2*Q.t2.v_12*d.t1.v_2 + 2*Q.t1.v_2*d.t2.v_12 +
            //     Q.t1.v_1*d.t2.v_22 + Q.t0*d.t3.v_122, Q.t3.v_222 + 3*Q.t2.v_22*d.t1.v_2 +
            ...
            // Q2_\mu\nu d_\delta + Q3
            auto Qn3 = SymTensor3d_3<T>{
                d.t1.v_0 * Qn2.v_00 + d.t1.v_0 * (Qn2.v_00 - d.t1.v_0 * Qn1.v_0)
                    + Q.t2.v_00 * d.t1.v_0 + Q.t3.v_000,
                d.t1.v_0 * Qn2.v_01 + d.t1.v_0 * (Qn2.v_01 - d.t1.v_0 * Qn1.v_1)
                    + Q.t2.v_00 * d.t1.v_1 + Q.t3.v_001,
                d.t1.v_0 * Qn2.v_02 + d.t1.v_0 * (Qn2.v_02 - d.t1.v_0 * Qn1.v_2)
                    + Q.t2.v_00 * d.t1.v_2 + Q.t3.v_002,
                d.t1.v_0 * Qn2.v_11 + d.t1.v_1 * (Qn2.v_01 - d.t1.v_0 * Qn1.v_1)
                    + Q.t2.v_01 * d.t1.v_1 + Q.t3.v_011,
                d.t1.v_0 * Qn2.v_12 + d.t1.v_1 * (Qn2.v_02 - d.t1.v_0 * Qn1.v_2)
                    + Q.t2.v_01 * d.t1.v_2 + Q.t3.v_012,
                d.t1.v_0 * Qn2.v_22 + d.t1.v_2 * (Qn2.v_02 - d.t1.v_0 * Qn1.v_2)
                    + Q.t2.v_02 * d.t1.v_2 + Q.t3.v_022,
                d.t1.v_1 * Qn2.v_11 + d.t1.v_1 * (Qn2.v_11 - d.t1.v_1 * Qn1.v_1)
                    + Q.t2.v_11 * d.t1.v_1 + Q.t3.v_111,
                d.t1.v_1 * Qn2.v_12 + d.t1.v_1 * (Qn2.v_12 - d.t1.v_1 * Qn1.v_2)
                    + Q.t2.v_11 * d.t1.v_2 + Q.t3.v_112,
                d.t1.v_1 * Qn2.v_22 + d.t1.v_2 * (Qn2.v_12 - d.t1.v_1 * Qn1.v_2)
                    + Q.t2.v_12 * d.t1.v_2 + Q.t3.v_122,
                d.t1.v_2 * Qn2.v_22 + d.t1.v_2 * (Qn2.v_22 - d.t1.v_2 * Qn1.v_2)
                    + Q.t2.v_22 * d.t1.v_2 + Q.t3.v_222};
